...
use saddle_rendering_2d_lighting::Lighting2dSystems;

use crate::scenarios;

pub struct Lighting2dLabE2EPlugin;

impl Plugin for Lighting2dLabE2EPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(saddle_bevy_e2e::E2EPlugin);
        app.configure_sets(Update, E2ESet.before(Lighting2dSystems::Prepare));
